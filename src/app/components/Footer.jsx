...
function Footer() {
  return (
    <section id='contact'>
        <div className='flex w-full h-full bg-[#c8c4f4] text-black justify-center'>
            <div className='py-8'>
                {/* <div className=''>
                    <p className='flex justify-center text-sm'>Thankyou for visiting my page</p>
                </div> */}
                <div className='text-white font-noto '>
                    <p className='flex justify-center mt-3 text-md lg:text-lg'>Contact me</p>
                    <div className='flex gap-5 justify-center mt-1'>
                        <Link href='mailto:wangsajeslyn@gmail.com'>
                            <button class="button">
                        ...
                        <Link href='https://www.linkedin.com/in/jeslynwangsa/' to="route" target="_blank">
                            <button class="button">
                            <svg className='w-5 h-5' viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg" fill="none"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><rect width="132" height="132" x="30" y="30" stroke="#fff" stroke-width="12" rx="16"></rect><path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="12" d="M66 86v44"></path><circle cx="66" cy="64" r="8" fill="#fff"></circle><path stroke="#fff" stroke-linecap="round" stroke-width="12" d="M126 130v-26c0-9.941-8.059-18-18-18v0c-9.941 0-18 8.059-18 18v26"></path></g></svg>
                            </button>
                        </Link>
                ...
                <div className='text-white font-noto'>
                    <p className='flex justify-center mt-3 text-md lg:text-lg'>© 2024 Jeslyn Wangsa</p>
                </div>
            </div>
        </div>
    </section>
